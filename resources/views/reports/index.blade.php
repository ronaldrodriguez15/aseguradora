    ...
    <div class="row justify-content-center">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <select class="form-control @error('estado') is-invalid @enderror" id="estado"
                                ...
                                <option value="sin_firmar" class="text-danger">Sin firmar</option>
                                <option value="pendiente" class="text-primary">Pendiente</option>
                                <option value="firmado" class="text-success">Firmado</option>
                            </select>
                            @error('estado')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
        ...
        <div class="col-md-11">
            <div class="mt-4" id="button-container">
                ...
                @endif
                @if (Auth::user()->hasRole('Administrador') || Auth::user()->hasRole('Jefe de ventas'))
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            $('#vendedor').select2({
                placeholder: "Selecciona uno o más vendedores",
                allowClear: true
            });
        });
