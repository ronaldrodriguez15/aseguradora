...
@section('content')
<p>En este modulo puedes consultar y generar reportes acerca de las afiliaciones que están en el sistema, asimismo, el rol encargado puede descargar los documentos firmados de la afiliación correspondiente.</p>
<br><br>
            ...
            <div id="debito_automatico_fields">
                ...
                <div class="form-row">
                    <div class="form-group col-md-3">
                        ...
                        <input type="date" class="form-control @error('fecha_desde') is-invalid @enderror" id="fecha_desde" name="fecha_desde">
                        @error('fecha_desde')
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="date" class="form-control @error('fecha_hasta') is-invalid @enderror" id="fecha_hasta" name="fecha_hasta">
                        @error('fecha_hasta')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <select class="form-control @error('aseguradora') is-invalid @enderror" id="aseguradora" name="aseguradora">
                ...
                <div class="form-row">
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control @error('numero_afiliacion') is-invalid @enderror" id="numero_afiliacion" name="numero_afiliacion" placeholder="Introduce el número de afiliación">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="date" class="form-control @error('fecha_afiliacion') is-invalid @enderror" id="fecha_afiliacion" name="fecha_afiliacion">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="number" class="form-control @error('cedula') is-invalid @enderror" id="cedula" name="cedula" placeholder="Introduce la cédula">
                        @error('cedula')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <input type="number" class="form-control @error('edad') is-invalid @enderror" id="edad" name="edad" placeholder="Introduce la edad">
                        @error('edad')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
