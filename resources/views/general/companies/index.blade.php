                ...
                <div class="table-responsive">
                    <table id="datatable" class="table">
                        ...
                        <tbody class="text-center">
                            ...
                            <tr>
                                <td>{{ $company['name'] }}</td>
                                <td>{{ $company['type_entity'] }}</td>
                                <td>{{ $company['area'] }}</td>
                                <td>{{ $company['official_in_charge'] }}</td>
                                ...
                                <td>
                                    ...
                                    <div class="button-container">
                                        <a class="btn btn-success btn-sm" href="{{ route('empresas.edit', $company['id']) }}" title="Editar"><i class="fas fa-edit"></i></a>
