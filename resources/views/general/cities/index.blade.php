...
@section('content')
<p>En este modulo puedes ver todo el registro de las ciudades, asimismo, puedes crear una nueva o editar las ya creadas.</p>
<br><br><br>

<div class="row justify-content-center">
    <div class="col-md-12 text-right mb-5">
        <a class="btn btn-success" id="btnNuevaCiudad">
            <i class="fas fa-plus-circle mr-2"></i>Nueva ciudad
        </a>
    </div>
    <div class="col-md-12">
        <!-- Controller response -->
                                ...
                                <td>
                                    ...
                                    <div class="button-container">
                                        <form action="{{ route('ciudades.destroy', $city['id']) }}" method="POST" id="formDelete-{{ $city['id'] }}">
                                            @method('DELETE')
                                            @csrf
                                            <button type="button" class="btn btn-danger btn-sm delete-btn" data-id="{{ $city['id'] }}" onclick="confirmDelete(this)" title="Eliminar">
