    ...
    <div class="row">
        ...
        <div class="card mb-5 shadow-sm">
            ...
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-md-4">
                        <strong>Operador Libranza:</strong><br>
                        @if ($entity->operador_libranza)
                            Sí
                        @else
                            No
                        @endif
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-4">
                        ...
                        @if ($entity->m_hibrido)
                            @if (Auth::user()->m_hibrido === '1' || Auth::user()->hasRole('Administrador') || Auth::user()->hasRole('Jefe de ventas') || Auth::user()->hasRole('Ventas'))
                                {{ $entity->m_hibrido }}
                            @else
                                <i class="text-muted">No disponible</i>
                            @endif
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        @if ($entity->d_asistencia)
                            @if (Auth::user()->d_asistencia === '1' || Auth::user()->hasRole('Administrador') || Auth::user()->hasRole('Jefe de ventas') || Auth::user()->hasRole('Ventas'))
                                {{ $entity->d_asistencia }}
                            @else
                                <i class="text-muted">No disponible</i>
                            @endif
                    ...
                    <div class="col-md-4">
                        ...
                        @if ($entity->d_numero_personas)
                            @if (Auth::user()->d_numero_personas === '1' || Auth::user()->hasRole('Administrador') || Auth::user()->hasRole('Jefe de ventas') || Auth::user()->hasRole('Ventas'))
                    ...
                    <div class="col-md-4">
                        ...
                        @if ($entity->v_salario_minimo)
                            @if (Auth::user()->v_salario_minimo === '1' || Auth::user()->hasRole('Administrador') || Auth::user()->hasRole('Jefe de ventas') || Auth::user()->hasRole('Ventas'))
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        @if ($entity->v_salario_maximo)
                            @if (Auth::user()->v_salario_maximo === '1' || Auth::user()->hasRole('Administrador') || Auth::user()->hasRole('Jefe de ventas') || Auth::user()->hasRole('Ventas'))
                    ...
                    <div class="col-md-4">
                        ...
                        @if ($entity->pago_nomina)
                            @if (Auth::user()->pago_nomina === '1' || Auth::user()->hasRole('Administrador') || Auth::user()->hasRole('Jefe de ventas') || Auth::user()->hasRole('Ventas'))
                                {{ $entity->pago_nomina }} 
                            @else
                                <i class="text-muted">No disponible</i>
                            @endif
                    ...
                    <div class="col-md-4">
                        ...
                        @if ($entity->m_socializacion)
                            @if (Auth::user()->m_socializacion === '1' || Auth::user()->hasRole('Administrador') || Auth::user()->hasRole('Jefe de ventas') || Auth::user()->hasRole('Ventas'))
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        @if ($entity->tthh_nombres)
                            @if (Auth::user()->tthh_nombres === '1' || Auth::user()->hasRole('Administrador') || Auth::user()->hasRole('Jefe de ventas') || Auth::user()->hasRole('Ventas'))
                                {{ $entity->tthh_nombres }}
                            @else
                                <i class="text-muted">No disponible</i>
                            @endif
                    ...
                    <div class="col-md-4">
                        ...
                        @if ($entity->tthh_cel1)
                            @if (Auth::user()->tthh_cel1 === '1' || Auth::user()->hasRole('Administrador') || Auth::user()->hasRole('Jefe de ventas') || Auth::user()->hasRole('Ventas'))
                                {{ $entity->tthh_cel1 }}
                            @else
                                <i class="text-muted">No disponible</i>
                            @endif
                    ...
                    <div class="col-md-4">
                        ...
                        @if ($entity->tthh_cel2)
                            @if (Auth::user()->tthh_cel2 === '1' || Auth::user()->hasRole('Administrador') || Auth::user()->hasRole('Jefe de ventas') || Auth::user()->hasRole('Ventas'))
                                {{ $entity->tthh_cel2 }}
                            @else
                                <i class="text-muted">No disponible</i>
                            @endif
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        @if ($entity->tthh_cel3)
                            @if (Auth::user()->tthh_cel3 === '1' || Auth::user()->hasRole('Administrador') || Auth::user()->hasRole('Jefe de ventas') || Auth::user()->hasRole('Ventas'))
                                {{ $entity->tthh_cel3 }}
                            @else
                                <i class="text-muted">No disponible</i>
                            @endif
                    ...
                    <div class="col-md-4">
                        ...
                        @if ($entity->tthh_email)
                            @if (Auth::user()->tthh_email === '1' || Auth::user()->hasRole('Administrador') || Auth::user()->hasRole('Jefe de ventas') || Auth::user()->hasRole('Ventas'))
                                {{ $entity->tthh_email }}
                            @else
                                <i class="text-muted">No disponible</i>
                            @endif
                    ...
                    <div class="col-md-4">
                        ...
                        @if ($entity->tthh_cargo)
                            @if (Auth::user()->tthh_cargo === '1' || Auth::user()->hasRole('Administrador') || Auth::user()->hasRole('Jefe de ventas') || Auth::user()->hasRole('Ventas'))
                                {{ $entity->tthh_cargo }}
                            @else
                                <i class="text-muted">No disponible</i>
                            @endif
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        @if ($entity->tthh_observaciones)
                            @if (Auth::user()->tthh_observaciones === '1' || Auth::user()->hasRole('Administrador') || Auth::user()->hasRole('Jefe de ventas') || Auth::user()->hasRole('Ventas'))
                    ...
                    <div class="col-md-4">
                        ...
                        @if ($entity->area_nomina_nombres)
                            @if (Auth::user()->area_nomina_nombres === '1' || Auth::user()->hasRole('Administrador') || Auth::user()->hasRole('Jefe de ventas') || Auth::user()->hasRole('Ventas'))
                    ...
                    <div class="col-md-4">
                        ...
                        @if ($entity->area_nomina_celular)
                            @if (Auth::user()->area_nomina_celular === '1' || Auth::user()->hasRole('Administrador') || Auth::user()->hasRole('Jefe de ventas') || Auth::user()->hasRole('Ventas'))
                    ...
                    <div class="col-md-4">
                        ...
                        @if ($entity->area_nomina_email)
                            @if (Auth::user()->area_nomina_email === '1' || Auth::user()->hasRole('Administrador') || Auth::user()->hasRole('Jefe de ventas') || Auth::user()->hasRole('Ventas'))
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        @if ($entity->area_nomina_cargo)
                            @if (Auth::user()->area_nomina_cargo === '1' || Auth::user()->hasRole('Administrador') || Auth::user()->hasRole('Jefe de ventas') || Auth::user()->hasRole('Ventas'))
                    ...
                    <div class="col-md-4">
                        ...
                        @if ($entity->area_nomina_observaciones)
                            @if (Auth::user()->area_nomina_observaciones === '1' || Auth::user()->hasRole('Administrador') || Auth::user()->hasRole('Jefe de ventas') || Auth::user()->hasRole('Ventas'))
                    ...
                    <div class="col-md-4">
                        ...
                        @if ($entity->observaciones_visado)
                            @if (Auth::user()->observaciones_visado === '1' || Auth::user()->hasRole('Administrador') || Auth::user()->hasRole('Jefe de ventas') || Auth::user()->hasRole('Ventas'))
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        @if ($entity->archivos_radicacion)
                            @if (Auth::user()->archivos_radicacion === '1' || Auth::user()->hasRole('Administrador') || Auth::user()->hasRole('Jefe de ventas') || Auth::user()->hasRole('Ventas'))
                    ...
                    <div class="col-md-4">
                        ...
                        @if ($entity->ea_nombres)
                            @if (Auth::user()->ea_nombres === '1' || Auth::user()->hasRole('Administrador') || Auth::user()->hasRole('Jefe de ventas') || Auth::user()->hasRole('Ventas'))
                                {{ $entity->ea_nombres }}
                            @else
                                <i class="text-muted">No disponible</i>
                            @endif
                    ...
                    <div class="col-md-4">
                        ...
                        @if ($entity->ea_cel)
                            @if (Auth::user()->ea_cel === '1' || Auth::user()->hasRole('Administrador') || Auth::user()->hasRole('Jefe de ventas') || Auth::user()->hasRole('Ventas'))
                                {{ $entity->ea_cel }}
                            @else
                                <i class="text-muted">No disponible</i>
                            @endif
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        @if ($entity->ea_email)
                            @if (Auth::user()->ea_email === '1' || Auth::user()->hasRole('Administrador') || Auth::user()->hasRole('Jefe de ventas') || Auth::user()->hasRole('Ventas'))
                                {{ $entity->ea_email }}
                            @else
                                <i class="text-muted">No disponible</i>
                            @endif
                    ...
                    <div class="col-md-4">
                        ...
                        @if ($entity->ea_cargo)
                            @if (Auth::user()->ea_cargo === '1' || Auth::user()->hasRole('Administrador') || Auth::user()->hasRole('Jefe de ventas') || Auth::user()->hasRole('Ventas'))
                                {{ $entity->ea_cargo }}
                            @else
                                <i class="text-muted">No disponible</i>
                            @endif
                    ...
                    <div class="col-md-4">
                        ...
                        @if ($entity->ea_observaciones)
                            @if (Auth::user()->ea_observaciones === '1' || Auth::user()->hasRole('Administrador') || Auth::user()->hasRole('Jefe de ventas') || Auth::user()->hasRole('Ventas'))
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        @if ($entity->at_nombres)
                            @if (Auth::user()->at_nombres === '1' || Auth::user()->hasRole('Administrador') || Auth::user()->hasRole('Jefe de ventas') || Auth::user()->hasRole('Ventas'))
                                {{ $entity->at_nombres }}
                            @else
                                <i class="text-muted">No disponible</i>
                            @endif
                    ...
                    <div class="col-md-4">
                        ...
                        @if ($entity->at_cel)
                            @if (Auth::user()->at_cel === '1' || Auth::user()->hasRole('Administrador') || Auth::user()->hasRole('Jefe de ventas') || Auth::user()->hasRole('Ventas'))
                                {{ $entity->at_cel }}
                            @else
                                <i class="text-muted">No disponible</i>
                            @endif
                    ...
                    <div class="col-md-4">
                        ...
                        @if ($entity->at_email)
                            @if (Auth::user()->at_email === '1' || Auth::user()->hasRole('Administrador') || Auth::user()->hasRole('Jefe de ventas') || Auth::user()->hasRole('Ventas'))
                                {{ $entity->at_email }}
                            @else
                                <i class="text-muted">No disponible</i>
                            @endif
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        @if ($entity->at_cargo)
                            @if (Auth::user()->at_cargo === '1' || Auth::user()->hasRole('Administrador') || Auth::user()->hasRole('Jefe de ventas') || Auth::user()->hasRole('Ventas'))
                                {{ $entity->at_cargo }}
                            @else
                                <i class="text-muted">No disponible</i>
                            @endif
                    ...
                    <div class="col-md-4">
                        ...
                        @if ($entity->at_observaciones)
                            @if (Auth::user()->at_observaciones === '1' || Auth::user()->hasRole('Administrador') || Auth::user()->hasRole('Jefe de ventas') || Auth::user()->hasRole('Ventas'))
                    ...
                    <div class="col-md-4">
                        ...
                        @if ($entity->codigo)
                            @if (Auth::user()->codigo === '1' || Auth::user()->hasRole('Administrador') || Auth::user()->hasRole('Jefe de ventas') || Auth::user()->hasRole('Ventas'))
                                {{ $entity->codigo }}
                            @else
                                <i class="text-muted">No disponible</i>
                            @endif
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        @if ($entity->{'1_1'})
                            @if (Auth::user()->{'1_1'} === '1' || Auth::user()->hasRole('Administrador') || Auth::user()->hasRole('Jefe de ventas') || Auth::user()->hasRole('Ventas'))
                                {{ $entity->{'1_1'} }}
                            @else
                                <i class="text-muted">No disponible</i>
                            @endif
                    ...
                    <div class="col-md-4">
                        ...
                        @if ($entity->ruta)
                            @if (Auth::user()->ruta === '1' || Auth::user()->hasRole('Administrador') || Auth::user()->hasRole('Jefe de ventas') || Auth::user()->hasRole('Ventas'))
                                {{ $entity->ruta }}
                            @else
                                <i class="text-muted">No disponible</i>
                            @endif
                    ...
                    <div class="col-md-4">
                        ...
                        @if ($entity->zona)
                            @if (Auth::user()->zona === '1' || Auth::user()->hasRole('Administrador') || Auth::user()->hasRole('Jefe de ventas') || Auth::user()->hasRole('Ventas'))
                                {{ $entity->zona }}
                            @else
                                <i class="text-muted">No disponible</i>
                            @endif
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        @if ($entity->codigo_postal)
                            @if (Auth::user()->codigo_postal === '1' || Auth::user()->hasRole('Administrador') || Auth::user()->hasRole('Jefe de ventas') || Auth::user()->hasRole('Ventas'))
                    ...
                    <div class="col-md-4">
                        ...
                        @if ($entity->afiliados_planta)
                            @if (Auth::user()->afiliados_planta === '1' || Auth::user()->hasRole('Administrador') || Auth::user()->hasRole('Jefe de ventas') || Auth::user()->hasRole('Ventas'))
                    ...
                    <div class="col-md-4">
                        ...
                        @if ($entity->afiliados_contratistas)
                            @if (Auth::user()->afiliados_contratistas === '1' || Auth::user()->hasRole('Administrador') || Auth::user()->hasRole('Jefe de ventas') || Auth::user()->hasRole('Ventas'))
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        @if ($entity->historial_afiliados)
                            @if (Auth::user()->historial_afiliados === '1' || Auth::user()->hasRole('Administrador') || Auth::user()->hasRole('Jefe de ventas') || Auth::user()->hasRole('Ventas'))
                    ...
                    <div class="col-md-4">
                        ...
                        @if ($entity->c_codigo)
                            @if (Auth::user()->c_codigo === '1' || Auth::user()->hasRole('Administrador') || Auth::user()->hasRole('Jefe de ventas') || Auth::user()->hasRole('Ventas'))
                                {{ $entity->c_codigo }}
                            @else
                                <i class="text-muted">No disponible</i>
                            @endif
                    ...
                    <div class="col-md-4">
                        ...
                        @if ($entity->apertura)
                            @if (Auth::user()->apertura === '1' || Auth::user()->hasRole('Administrador') || Auth::user()->hasRole('Jefe de ventas') || Auth::user()->hasRole('Ventas'))
                                {{ $entity->apertura }}
                            @else
                                <i class="text-muted">No disponible</i>
                            @endif
