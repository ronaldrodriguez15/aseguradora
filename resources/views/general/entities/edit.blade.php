            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    <div style="display: flex; align-items: center; gap: 8px;">
                        <input type="hidden" name="operador_libranza" value="0">
                        <input type="checkbox" class="js-switch" id="operador_libranza" name="operador_libranza"
                        value="1" {{ old('operador_libranza', $entity->operador_libranza) ? 'checked' : '' }}>
                        <label class="d-block" for="operador_libranza">Operador Libranza</label>
                    </div>
                </div>
            </div>
            <div class="form-row">
...
@section('js')
    <script>
        $(document).ready(function() {
            ...
            var switchElems = Array.prototype.slice.call(document.querySelectorAll('.js-switch'));
            ...
            $('#department').on('change', function() {
                ...
                if (departmentName) {
                    $('input[type="hidden"][name="department"]').remove();
                    $('<input>').attr({
                        type: 'hidden',
                        name: 'department',
