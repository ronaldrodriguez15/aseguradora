...
<div class="container">
    ...
    <div class="progress" style="position: relative; width: 100%; height: 30px;">
        <div class="progress-bar progress-bar-striped progress-bar-animated bg-warning rounded" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" style="width: 50%; height: 100%;"></div>
            ...
            <div class="card-body">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control"
                            id="porcentaje_s1" name="porcentaje_s1" placeholder="%0">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="tipo_identidad_s1">Tipo de identidad <span class="required">*</span></label>
                        <select class="form-control @error('tipo_identidad_s1') is-invalid @enderror" id="tipo_identidad_s1"
                            name="tipo_identidad_s1">
                            <option value="">Selecciona el tipo</option>
                            <option value="cedula_ciudadania">Cédula de ciudadanía</option>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="number" class="form-control"
                            id="n_identificacion_s1" name="n_identificacion_s1" placeholder="Introduce el No de indetificación">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control"
                            id="porcentaje_s2" name="porcentaje_s2" placeholder="%0">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="tipo_identidad_s2">Tipo de identidad <span class="required">*</span></label>
                        <select class="form-control @error('tipo_identidad_s2') is-invalid @enderror" id="tipo_identidad_s2"
                            name="tipo_identidad_s2">
                            <option value="">Selecciona el tipo</option>
                            <option value="cedula_ciudadania">Cédula de ciudadanía</option>
                            <option value="cedula_extranjeria">Cédula de extranjeria</option>
                            <option value="documento_identificacion">Documento de identificación</option>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="number" class="form-control"
                            id="n_identificacion_s2" name="n_identificacion_s2" placeholder="Introduce el No de indetificación">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control"
                            id="porcentaje_s3" name="porcentaje_s3" placeholder="%0">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="tipo_identidad_s3">Tipo de identidad <span class="required">*</span></label>
                        <select class="form-control @error('tipo_identidad_s3') is-invalid @enderror" id="tipo_identidad_s3"
                            name="tipo_identidad_s3">
                            <option value="">Selecciona el tipo</option>
                            <option value="cedula_ciudadania">Cédula de ciudadanía</option>
                            <option value="cedula_extranjeria">Cédula de extranjeria</option>
                            <option value="documento_identificacion">Documento de identificación</option>
                    ...
                    <div class="form-group col-md-6">
                        <label for="n_identificacion_s1">Número de identificación</label>
                        <input type="number" class="form-control"
                            id="n_identificacion_s3" name="n_identificacion_s3" placeholder="Introduce el No de indetificación">
                    </div>
                </div>
            </div>
        </div>
