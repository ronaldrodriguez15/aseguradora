        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-4 text-right">
                    ...
                    <a class="btn btn-primary mb-4" id="consultar-documentos" data-id="{{ $inabilityId }}" href="#">
        ...
        $('#consultar-documentos').on('click', function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    Swal.fire('Éxito',
                        'Los documentos han sido firmados y guardados correctamente.',
                        'success');

                },
                error: function(xhr) {
                    Swal.fire('Info', 'Los documentos aún no han sido firmados. Por favor, espere e intente en unos minutos.',
                        'error');
                }
            });
        });
