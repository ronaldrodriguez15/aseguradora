...
<div class="container">
    ...
    <div class="progress" style="position: relative; width: 100%; height: 30px;">
        <div class="progress-bar progress-bar-striped progress-bar-animated bg-success rounded" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" style="width: 100%; height: 100%;"></div>
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-3 text-right">
                    ...
                    <a class="btn btn-danger mb-4" href="{{ route('incapacidades.generarPDF', $inabilityId) }}" target="_blank">
