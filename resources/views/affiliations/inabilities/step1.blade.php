...
@section('content')
<div class="container">
    <form autocomplete="off" action="{{ route('incapacidades.formStepTwo') }}" method="post">
        @csrf
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-8">
                        ...
                        <input type="nombre_asesor" class="form-control @error('nombre_asesor') is-invalid @enderror" id="nombre_asesor"
                            name="nombre_asesor" placeholder="Introduce el Nombre completo" required>
                        @error('nombre_asesor')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" id="tu_pierdes" name="tu_pierdes" class="form-control is-invalid" readonly disabled>
                        </div>
                        @error('descuento_eps')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <input type="number" id="edad" name="edad" class="form-control is-valid" readonly disabled>
                    </div>
                </div>
