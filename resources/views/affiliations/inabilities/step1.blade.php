                ...
                <div class="form-row">
                    <div class="form-group col-md-4">
                        ...
                        <select class="form-control @error('codigo_asesor') is-invalid @enderror" id="asesor_code"
                            ...
                            <option value="{{ $asesor['asesor_code'] }}" data-name="{{ $asesor['name'] }}" data-identificador="{{ $asesor['consecutivo'] }}">
                                {{ $asesor['asesor_code'] }}
                            </option>
                            @endforeach
                        </select>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="number" class="form-control" name="gastos_administrativos"
                                id="gastos_administrativos" value="0" placeholder="00000" required readonly>
                        </div>
