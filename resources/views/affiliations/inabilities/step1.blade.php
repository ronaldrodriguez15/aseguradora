...
@section('content')
                ...
                <div class="card-body">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" name="descuento_eps" id="descuento_eps"
                                    placeholder="calculo automatico" required>
                            </div>
                            @error('password')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="form-group col-md-3 d-flex align-items-end mb-4">
                            <button type="button" class="btn btn-danger" data-toggle="modal" id="botonTuPierdes"
                                data-target="#tuPierdesModal" onclick="calcularPerdida()">
                                TU PIERDES!!! <i class="fas fa-calculator ml-2 mt-1"></i>
                            </button>
                        </div>

                        <div class="form-group col-md-3 d-flex align-items-end mb-4">
                            <button type="button" class="btn btn-info" data-toggle="modal" id="botonTePagamos"
                                data-target="#tePagamosModal" onclick="calcularPagamos()" style="display: none;">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" name="valor_adicional" id="valor_adicional"
                                    value="2408856" placeholder="sin comas ni puntos" disabled>
                            </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            <label for="amparo_basico">Amparo basico (muerte por alguna causa) <span
                                    class="required">*</span></label>
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">$</span>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="gastos_administrativos">Gastos administrativos <span
                                    class="required">*</span></label>
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">$</span>
                                </div>
                                <input type="text" class="form-control" name="gastos_administrativos"
                                    id="gastos_administrativos" value="0" placeholder="00000" required>
                            </div>
    ...
    <!--  TU PIERDES!!! -->
    <div class="modal fade" id="tuPierdesModal" tabindex="-1" role="dialog" aria-labelledby="tuPierdesModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Ten en cuenta haber diligenciado los campos <b>Número de días</b> y <b>Valor IBC básico</b> para la
                    operación.
                    <br><br>
    ...
    <div class="modal fade" id="tePagamosModal" tabindex="-1" role="dialog" aria-labelledby="tePagamosModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Ten en cuenta haber diligenciado el campo <b>Número de días</b> y haber realizado el cálculo de <b>Tú
                        Pierdes</b> para la operación.
                    <br><br>
                    <div class="text-center">
