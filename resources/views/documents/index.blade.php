...
@section('content')
    ...
    <!-- Modal EstaSSeguro -->
    <div class="modal fade" id="uploadEstasseguro" tabindex="-1" role="dialog" aria-labelledby="uploadEstasseguroLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="formNuevaAseguradora" autocomplete="off" action="{{ route('documentos.store') }}"
